...
public class Main {
    ...
    private static void runApp() {
        ...
        switch (selectMenu) {
            case 1:
                if (listUser.isEmpty()){
                    System.out.println("Belum ada pengguna terdaftar. Silahkan registrasi terlebih dahulu");
                    showRegisterMenu();
                } else {
    ...
    private static void showLoginMenu() {
        ...
        if (userIndex != -1) {
            ...
            System.out.println("Username tidak ditemukan, silahkan coba lagi");
            showLoginMenu();
        }
    }
    ...
    private static void showDetailUser(Profile profile) {
        ...
        System.out.println("Nama panggilan  : " + profile.gwtNickname());
