public class TP3_2_H071231055 {

    String name;
    double speed, cash;
    int winningAmount;
    
    public TP3_2_H071231055(){
    }

    public TP3_2_H071231055(String name, double speed, double cash, int winningAmount) {
      this.name = name;
      this.speed = speed;
      this.cash = cash;
    ...
    public void raceTo(TP3_2_H071231055 enemy) {
    ...
    public static void main(String[] args) {
      TP3_2_H071231055 marcebesDenz = new TP3_2_H071231055("Mercebes-Denz", 4, 20000, 0);
      
      TP3_2_H071231055 ferharri = new TP3_2_H071231055(null, 0, 0, 0);
