...
public class App extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        Image imageIcon = new Image(getClass().getClassLoader().getResourceAsStream("logo.jpg"));
        if (imageIcon == null) {
    ...
    private Scene registerScene(Stage stage) {
        ...
        username1.getStyleClass().add("input");
        username1.relocate(90, 220);
        username2.relocate(190, 220);
        username2.getStyleClass().add("tabelInput");
        ...
        Pane root = new Pane();
        root.getChildren().addAll(registerLabel, nama1, nama2, dateField, dateLabel, username1, username2,
                passwordField, passwordLabel, submit, salah1, back);
        root.getStyleClass().add("latar");
    ...
    private Scene registerSuccess(Stage stage) {
        Label success = new Label("Congrats, Registration Successful!");
        success.getStyleClass().add("judul");
        success.relocate(50, 170);
    ...
    private Scene loginScene(Stage stage) {
        ...
        Pane root = new Pane();
        root.getChildren().addAll(loginLabel, passLogin, passwordFieldLogin, usernameLogin1, usernameLogin2, back,
                submit1, salah2);
        root.getStyleClass().add("latar");
        Scene scene = new Scene(root, 640, 480);
        scene.getStylesheets().add(getClass().getResource("/Style/Style.css").toExternalForm());
