...
class Task extends TP8_1_H071231067 implements Runnable{
    int time;
...
class UiThread extends TP8_1_H071231067 implements Runnable{
    int detik;
...
public class TP8_1_H071231067 extends TaskTimeHelper{
    static int failed;
    static int done;
