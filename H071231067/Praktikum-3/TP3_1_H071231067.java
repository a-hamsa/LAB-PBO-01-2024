...
class StarRail {
    ...
    public StarRail(String namaChar,int health,int damageBasicAtt,int damageskill ,int maxultipoint, String namaUlti, int damageUlti ){
    ...
    public void basicAttack(StarRail musuh){
    ...
    public void ultiAttack(StarRail musuh){
    ...
    public void skillAttack(StarRail musuh){
...
public class TP3_1_H071231067{
    public static void main(String[] args){
        Ulti ulti1 = new Ulti();
            ulti1.setNamaUlti("Ulti");
            ulti1.setDamageUlti(50);
        StarRail char1 = new StarRail();
            char1.setnamaChar("Acheron");
            char1.setHealth(100);
        ...
        Ulti ulti2 = new Ulti("Musuh",20);
        StarRail char2 = new StarRail("Musuh",100,10,20,2,ulti2.getnamaUlti(),ulti2.getdamageUlti());
