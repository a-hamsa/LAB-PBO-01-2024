...
public class UIThread implements Runnable{
    ...
    public static int data_yang_blm_selesai = 0;
    ...
    public void run() {
        ...
        if (data_yang_sudah_selesai == data_yang_blm_selesai) {
            System.out.println("All Data Is Successfully Loaded");
        } else {
            System.out.println(data_yang_sudah_selesai +" Successfully Loaded & " + data_yang_blm_selesai + " Data Failed To Load");
        }
    }
